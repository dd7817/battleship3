				...
				if (targetMode) {
					...
					do {
						if (cardinals[NORTH]) {        /* NORTH */
							...
							if (checkShot (playerOneGameBoard, targetTemp) != -1 && north >= 0) {//changes != -1 to == 1
							...
							if (checkShot (playerOneGameBoard, targetTemp) != -1 && south <= 9) {//changes != -1 to == 1
							...
							if (checkShot (playerOneGameBoard, targetTemp) != -1 && west >= 0) {//changes != -1 to == 1
								cardinals[WEST] = TRUE;
							}
							...
							if (checkShot (playerOneGameBoard, targetTemp) != -1 && east <= 9) {//changes != -1 to == 1
								cardinals[EAST] = TRUE;
							}
